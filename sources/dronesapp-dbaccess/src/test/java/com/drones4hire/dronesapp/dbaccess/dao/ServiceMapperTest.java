...
public class ServiceMapperTest extends AbstractTestNGSpringContextTests {
    ...
    @Test(enabled = ENABLED, dependsOnMethods = {"createServiceTest"})
    ...
    @Test(enabled = ENABLED, dependsOnMethods = {"getServiceByIdTest"})
    public void getAllServicesTest()
    {
        List<Service> services = serviceMapper.getAllServices();
        checkService(services.get(services.size() - 1));
    }

    @Test(enabled = ENABLED, dependsOnMethods = {"getAllServicesTest"})
    ...
    @Test(enabled = ENABLED, dependsOnMethods = {"updateServiceTest"})
