        ...
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;">
            ...
            <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <p class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-family: arial,sans-serif;font-size: 16px;line-height: 24px;" lang="x-size-16"><span class="font-arial"><span style="color:rgb(9, 11, 13)">Hello ${User.username}! </span></span></p><p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-family: arial,sans-serif;font-size: 16px;line-height: 24px;" lang="x-size-16"><span class="font-arial"><span style="color:rgb(9, 11, 13)">Pilot ${Pilot.username} is ready to start your project ${Project.title}. Please use the message board on your <a style="text-decoration: none" href="${projectUrl}"><strong>Project Description</strong></a> page to discuss additional details if needed.</span></span></p>
                </div>
